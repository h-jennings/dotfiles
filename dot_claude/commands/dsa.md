---
description: DSA A Day — algorithm & data-structure practice. First word picks the mode (default practice).
argument-hint: "[teach|quiz|sync] | [quick|standard|deep] [topic]"
---

Use the **dsa-a-day** skill. Route by the first word of "$ARGUMENTS":
