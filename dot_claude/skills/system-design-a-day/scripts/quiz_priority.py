#!/usr/bin/env python3
"""
Prioritize front-end system design problems and concepts for quizzing based on
spaced repetition.
...
def main():
    parser = argparse.ArgumentParser(
        description="Prioritize system design content for quizzing via spaced repetition"
    )
    parser.add_argument(
        "--type",
    ...
    if not repo_path.exists():
        print("No system-design repo found at ~/system-design-a-day/. Run setup.py first.")
        return
    ...
    for i, item in enumerate(items, 1):
        ...
        print(f"{i}. [{ct}{cat_label}] {title}{status_str}")
